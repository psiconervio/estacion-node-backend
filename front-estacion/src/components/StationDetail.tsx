...
import type { StationDetailsProps, TimeRange } from '../types';
...
export default function StationDetails({ station, onClose }: StationDetailsProps) {
  ...
  // Generate more historical data based on the selected time range
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `Historical Data - ${TIME_RANGES[timeRange].label}`,
      },
      tooltip: {
        enabled: true,
        mode: 'index' as const,
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Coordinates: {station.coordinates.latitude}°N, {station.coordinates.longitude}°W
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              >
        ...
        <div className="border-t pt-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center text-gray-600">
              ...
              <span className="text-sm">System Health: 98%</span>
            </div>
